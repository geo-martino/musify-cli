...
from musify_cli.config import Config
...
runtime.add_argument(
    "-c", "--config", type=str, required=True, nargs="?", dest="config_path",
...
named_args = parser.parse_known_args()[0]

conf = Config(named_args.config_path)
if named_args.log_config_path:
...
if not glob(join(conf.output_folder, "*")):
